                    ...
                    if ($jsonFile->exists()) {
                        ...
                        if (\count($jsonModel) > 0) {
                            ...
                            if (\count($migrationItems) > 0) {
                                ...
                                $migrations .= '<hr>';
                                $migrationButton = '<button data-do="' . Input::get('do') . '" data-id="' . Input::get('id') . '" data-act="' . Input::get('act') . '" data-rt="' . Input::get('rt') . '" data-controller="AlpdeskDatabaseController" data-action="click->AlpdeskDatabaseController#migrate" class="tl_submit">' . $GLOBALS['TL_LANG']['tl_alpdeskcore_databasemanager']['migratelink'] . '</button>';
